...
def trainer_synapse(args, model, snapshot_path, multimask_output, low_res):
    ...
    # low_res=embedding_size*4=128; and output_size=input_size=512
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            low_res_label_batch = sampled_batch['low_res_label'] #the shape of output mask is the same of input mask
