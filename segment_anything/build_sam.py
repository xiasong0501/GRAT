...
def _build_sam(
    ...
    # print(image_embedding_size,ratio)
    sam = Sam(
    ...
    if checkpoint is not None:
        ...
        try:
            ...
            new_state_dict = load_from(sam, state_dict, image_size, vit_patch_size,encoder_embed_dim)
            sam.load_state_dict(new_state_dict)
    return sam, image_embedding_size


def load_from(sam, state_dict, image_size, vit_patch_size,encoder_embed_dim):
    ...
    if pos_embed.shape[1] != token_size:
        ...
        if encoder_embed_dim == 1024:
            # global_rel_pos_keys = [k for k in rel_pos_keys if '2' in k or '5' in  k or '8' in k or '11' in k]
            # global_rel_pos_keys = [k for k in rel_pos_keys if '5' in k or '11' in  k or '17' in k or '23' in k]
